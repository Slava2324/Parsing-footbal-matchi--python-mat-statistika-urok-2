...
+ 1. install required python libraries: selenium, pandas, IPython use this command ```python3 -m pip install selenium pandas ipython```
+ 2. launch the block codes in the following order
    * 2.1 Imports
    * 2.2 Setting up options
    * 2.3 Getting data
    * 2.4 Sorting data, making dataframe and saving to the file
